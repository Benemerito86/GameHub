...
<style>
    ...
    .back-link:hover { 
        background: linear-gradient(45deg, #f48fb1, #a7f0ba, #b3e5fc); 
        transform: scale(1.05);
        box-shadow: 0 8px 20px rgba(167, 240, 186, 0.4);
    }
    .rating-badge {
        display: inline-block;
...
<div class="game-detail">
    ...
    <a href="{{ route('games.index') }}" class="back-link">🌸 ← Volver al catálogo couzy</a>
</div>
@endsection